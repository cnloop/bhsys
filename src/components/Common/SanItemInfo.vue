            ...
            <div class="sanItemInfo-box-center">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="nClass"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="fileName"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="count"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
