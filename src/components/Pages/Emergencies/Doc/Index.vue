<template>
    <section class="docEmergencies">
        ...
        <section class="docEmergencies-main-wrap">
...
.docEmergencies > .nav-bar-current-wrap {
  height: 46px;
}
.docEmergencies > .nav-bar-tab-wrap {
  height: 56px;
}
.docEmergencies > .docEmergencies-main-wrap {
  position: absolute;
  top: 124px;
  bottom: 0px;
  left: 12px;
