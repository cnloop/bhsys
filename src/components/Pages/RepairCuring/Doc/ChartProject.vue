...
.chartProject-top .mx-datepicker {
  width: 180px;
  padding: 0px 8px;
}
.chartProject-top .mx-input {
  height: 32px;
  font-size: 12px;
}
.chartProject-top .classSelectedText {
  padding-left: 20px;
  padding-right: 8px;
}
.chartProject-top .classSelectedOne {
  vertical-align: middle;
}
.chartProject-top .seatchBtn {
  vertical-align: middle;
  margin: 0px 20px;
}
.chartProject-top .addBtn {
  vertical-align: middle;
}
