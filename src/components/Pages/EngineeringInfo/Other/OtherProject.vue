<template>
    <section class="otherProject">
        ...
        <section class="otherProject-center">
            <san-class-set-up-table :tableTheadData="tableTheadData" :tableTbodyData="tableTbodyData"></san-class-set-up-table>
        </section>
        <section class="otherProject-bottom">
            <div class="otherProject-bottom-wrap tb-center">
...
.otherProject-top .mx-datepicker {
  width: 180px;
  padding: 0px 8px;
}
.otherProject-top .mx-input {
  height: 32px;
  font-size: 12px;
}
.otherProject-top .classSelectedText {
  padding-left: 20px;
  padding-right: 8px;
}
.otherProject-top .classSelectedOne {
  vertical-align: middle;
}
.otherProject-top .seatchBtn {
  vertical-align: middle;
  margin: 0px 20px;
}
.otherProject-top .addBtn {
  vertical-align: middle;
}
...
.otherProject-bottom-wrap {
  right: 0px;
}

.otherProject-bottom-wrap .page-item {
  float: left;
  width: 60px;
  height: 40px;
  line-height: 40px;
...
.otherProject-bottom-wrap .page-link-item {
  height: 100%;
...
.otherProject-bottom-wrap .prev-item {
  float: left;
  height: 40px;
  line-height: 40px;
}
.otherProject-bottom-wrap .prev-link-item {
  height: 100%;
  display: inline-block;
  padding: 0 10px;
  text-align: center;
...
.otherProject-bottom-wrap .next-item {
  display: inline-block;
  height: 40px;
  line-height: 40px;
}
.otherProject-bottom-wrap .next-link-item {
  height: 100%;
  display: inline-block;
  padding: 0 10px;
  text-align: center;
...
.otherProject-bottom-wrap .active-item > .page-link-item {
  color: #fff !important;
...
.otherProject-bottom-wrap .disabled-item {
  cursor: not-allowed;
}
.otherProject-bottom-wrap .disabled-item > .prev-link-item {
  color: #ddd;
  cursor: not-allowed;
}
