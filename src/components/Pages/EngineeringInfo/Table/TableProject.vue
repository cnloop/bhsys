...
.tableProject-top .mx-datepicker {
  width: 180px;
  padding: 0px 8px;
}
.tableProject-top .mx-input {
  height: 32px;
  font-size: 12px;
}
.tableProject-top .classSelectedText {
  padding-left: 20px;
  padding-right: 8px;
}
.tableProject-top .classSelectedOne {
  vertical-align: middle;
}
.tableProject-top .seatchBtn {
  vertical-align: middle;
  margin: 0px 20px;
}
.tableProject-top .addBtn {
  vertical-align: middle;
}
...
.tableProject-bottom-wrap {
  right: 0px;
}

.tableProject-bottom-wrap .page-item {
  float: left;
  width: 60px;
  height: 40px;
  line-height: 40px;
...
.tableProject-bottom-wrap .page-link-item {
  height: 100%;
...
.tableProject-bottom-wrap .prev-item {
  float: left;
  height: 40px;
  line-height: 40px;
}
.tableProject-bottom-wrap .prev-link-item {
  height: 100%;
  display: inline-block;
  padding: 0 10px;
  text-align: center;
...
.tableProject-bottom-wrap .next-item {
  display: inline-block;
  height: 40px;
  line-height: 40px;
}
.tableProject-bottom-wrap .next-link-item {
  height: 100%;
  display: inline-block;
  padding: 0 10px;
  text-align: center;
...
.tableProject-bottom-wrap .active-item > .page-link-item {
  color: #fff !important;
...
.tableProject-bottom-wrap .disabled-item {
  cursor: not-allowed;
}
.tableProject-bottom-wrap .disabled-item > .prev-link-item {
  color: #ddd;
  cursor: not-allowed;
}
.tableProject-bottom-wrap .disabled-item > .next-link-item {
  color: #ddd;
  cursor: not-allowed;
}
.tableProject-bottom {
