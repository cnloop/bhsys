<template>
    <section class="baseProject">
        <section class="baseProject-top">
            <span>时间选择：</span>
        ...
        <section class="baseProject-center">
            <san-class-set-up-table :tableTheadData="tableTheadData" :tableTbodyData="tableTbodyData"></san-class-set-up-table>
        </section>
        <section class="baseProject-bottom">
            <div class="baseProject-bottom-wrap tb-center">
...
.baseProject-top .mx-datepicker {
  width: 180px;
  padding: 0px 8px;
}
.baseProject-top .mx-input {
  height: 32px;
  font-size: 12px;
}
.baseProject-top .classSelectedText {
  padding-left: 20px;
  padding-right: 8px;
}
.baseProject-top .classSelectedOne {
  vertical-align: middle;
}
.baseProject-top .seatchBtn {
  vertical-align: middle;
  margin: 0px 20px;
}
.baseProject-top .addBtn {
  vertical-align: middle;
}
...
.baseProject-bottom-wrap {
  right: 0px;
}

.baseProject-bottom-wrap .page-item {
  float: left;
  width: 60px;
  height: 40px;
  line-height: 40px;
...
.baseProject-bottom-wrap .page-link-item {
  height: 100%;
...
.baseProject-bottom-wrap .prev-item {
  float: left;
  height: 40px;
  line-height: 40px;
}
.baseProject-bottom-wrap .prev-link-item {
  height: 100%;
  display: inline-block;
  padding: 0 10px;
  text-align: center;
...
.baseProject-bottom-wrap .next-item {
  display: inline-block;
  height: 40px;
  line-height: 40px;
}
.baseProject-bottom-wrap .next-link-item {
  height: 100%;
  display: inline-block;
  padding: 0 10px;
  text-align: center;
...
.baseProject-bottom-wrap .active-item > .page-link-item {
  color: #fff !important;
...
.baseProject-bottom-wrap .disabled-item {
  cursor: not-allowed;
}
.baseProject-bottom-wrap .disabled-item > .prev-link-item {
  color: #ddd;
  cursor: not-allowed;
}
.baseProject-bottom-wrap .disabled-item > .next-link-item {
  color: #ddd;
  cursor: not-allowed;
}
.baseProject-bottom {
