<template>
    <section class="designSetUp">
        ...
        <section class="designSetUp-main-wrap">
...
.designSetUp > .nav-bar-current-wrap {
  height: 46px;
}
.designSetUp > .nav-bar-tab-wrap {
  height: 56px;
}
.designSetUp > .designSetUp-main-wrap {
  position: absolute;
  top: 124px;
  bottom: 0px;
  left: 12px;
