<template>
    <section class="SanTable">
        <table>
            ...
            <tbody>
                <tr v-for="(item,index) in tableTbodyData" :key="item.id">
                    ...
                    <td>
                        <span>{{item.upWaterLevel}}</span>
                    </td>
                    <td>
                        <span>{{item.downWaterLevel}}</span>
                    </td>
                    <td>
                        <span>{{item.yc}}</span>
                    </td>
        ...
        <run-item :itemInfo="itemInfo" :isShowItemInfo="isShowItemInfo" @sanItemInfoCallBack="sanItemInfoCallBack"></run-item>
    </section>
</template>
<script>
...
import RunItem from "@/components/ItemCom/EngineeringInfo/RunItem";
