<template>
    <section class="SanTable">
        ...
        <make-item :itemInfo="itemInfo" :isShowItemInfo="isShowItemInfo" @sanItemInfoCallBack="sanItemInfoCallBack"></make-item>
    </section>
</template>
<script>
...
import ManageItem from "@/components/ItemCom/Emergencies/ManageItem";
import MakeItem from "@/components/ItemCom/Emergencies/MakeItem";
