            ...
            <div class="sanItemInfo-box-center">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="emergencies"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="planName"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="result"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
...
export default {
  ...
  created() {
    ...
    this.emergencies = this.itemInfo.emergencies;
    this.planName = this.itemInfo.planName;
    this.result = this.itemInfo.result;
