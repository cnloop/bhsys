<template>
    <section class="SanTable">
        ...
        <note-item :itemInfo="itemInfo" :isShowItemInfo="isShowItemInfo" @sanItemInfoCallBack="sanItemInfoCallBack"></note-item>
    </section>
</template>
<script>
...
import StartItem from "@/components/ItemCom/Emergencies/StartItem";
import NoteItem from "@/components/ItemCom/Emergencies/NoteItem";
