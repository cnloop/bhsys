            ...
            <div class="sanItemInfo-box-center">
                <table>
                    <tr>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="roleName"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="engName"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="org"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="rang"></san-input>
                        </td>
                    </tr>
                </table>
            </div>
...
export default {
  ...
  created() {
    this.roleName = this.itemInfo.roleName;
    this.engName = this.itemInfo.engName;
    this.org = this.itemInfo.org;
    this.rang = this.itemInfo.rang;
  },
  components: {
    SanInput,
    SanBaseButton
