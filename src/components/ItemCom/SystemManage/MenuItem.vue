            ...
            <div class="sanItemInfo-box-center">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="link"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="sort"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="show"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="auth"></san-input>
                        </td>
                    </tr>
                </table>
            </div>
...
export default {
  ...
  created() {
    ...
    this.link = this.itemInfo.link;
    this.sort = this.itemInfo.sort;
    this.show = this.itemInfo.show;
    this.auth = this.itemInfo.auth;
  },
  components: {
    SanInput,
    SanBaseButton
