<template>
    <section class="SanTable">
        ...
        <role-item :itemInfo="itemInfo" :isShowItemInfo="isShowItemInfo" @sanItemInfoCallBack="sanItemInfoCallBack"></role-item>
    </section>
</template>
<script>
...
import RoleItem from "@/components/ItemCom/SystemManage/RoleItem";
