<template>
    <section class="SanTable">
        ...
        <menu-item :itemInfo="itemInfo" :isShowItemInfo="isShowItemInfo" @sanItemInfoCallBack="sanItemInfoCallBack"></menu-item>
    </section>
</template>
<script>
...
import MenuItem from "@/components/ItemCom/SystemManage/MenuItem";
