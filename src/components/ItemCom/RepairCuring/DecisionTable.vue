<template>
    <section class="SanTable">
        ...
        <decision-item :itemInfo="itemInfo" :isShowItemInfo="isShowItemInfo" @sanItemInfoCallBack="sanItemInfoCallBack"></decision-item>
    </section>
</template>
<script>
...
import DecisionItem from "@/components/ItemCom/RepairCuring/DecisionItem";
