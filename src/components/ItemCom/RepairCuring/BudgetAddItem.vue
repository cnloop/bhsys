            ...
            <div class="sanItemInfo-box-center">
                <table>
                    <tr>
                        ...
                        <td>
                            <san-input :sanInputDisabled="false" :sanInputValue.sync="projectName"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="false" :sanInputValue.sync="model"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="false" :sanInputValue.sync="machine"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="false" :sanInputValue.sync="budget"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
...
export default {
  ...
  created() {
    ...
    this.model = this.itemInfo.model;
    this.machine = this.itemInfo.machine;
    this.budget = this.itemInfo.budget;
