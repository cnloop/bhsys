<template>
    <section class="SanTable">
        ...
        <check-item :itemInfo="itemInfo" :isShowItemInfo="isShowItemInfo" @sanItemInfoCallBack="sanItemInfoCallBack"></check-item>
    </section>
</template>
<script>
...
import CheckItem from "@/components/ItemCom/RepairCuring/CheckItem";
