            ...
            <div class="sanItemInfo-box-center">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="budget"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="checkResult"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="checkPerson"></san-input>
                        </td>
                    </tr>
                </table>
            </div>
...
export default {
  ...
  created() {
    ...
    this.checkResult = this.itemInfo.checkResult;
    this.checkPerson = this.itemInfo.checkPerson;
  },
  components: {
    SanInput,
    SanBaseButton
