<template>
    <section class="SanTable">
        ...
        <progress-item :itemInfo="itemInfo" :isShowItemInfo="isShowItemInfo" @sanItemInfoCallBack="sanItemInfoCallBack"></progress-item>
    </section>
</template>
<script>
...
import ProgressItem from "@/components/ItemCom/RepairCuring/ProgressItem";
export default {
