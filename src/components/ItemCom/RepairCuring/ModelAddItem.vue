            ...
            <div class="sanItemInfo-box-center">
                <table>
                    <tr>
                        ...
                        <td>
                            <san-input :sanInputDisabled="false" :sanInputValue.sync="className"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="false" :sanInputValue.sync="grade"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="false" :sanInputValue.sync="summary"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="false" :sanInputValue.sync="desc"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="false" :sanInputValue.sync="trouble"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="false" :sanInputValue.sync="troubleDesc"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="false" :sanInputValue.sync="plan"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="false" :sanInputValue.sync="planDesc"></san-input>
                        </td>
                    </tr>
                </table>
            </div>
