<template>
    <section class="SanTable">
        <table>
            ...
            <tbody>
                <tr v-for="(item,index) in tableTbodyData" :key="item.id">
                    ...
                    <td>
                        <span>{{item.troubleDesc}}</span>
                    </td>
                    <td>
                        <span>{{item.plan}}</span>
                    </td>
                    <td>
                        <span>{{item.planDesc}}</span>
                    </td>
                    <td class="action">
                        <span>
        ...
        <model-item :itemInfo="itemInfo" :isShowItemInfo="isShowItemInfo" @sanItemInfoCallBack="sanItemInfoCallBack"></model-item>
    </section>
</template>
<script>
...
import ModelItem from "@/components/ItemCom/RepairCuring/ModelItem";
