<template>
    <section class="SanTable">
        ...
        <budget-item :itemInfo="itemInfo" :isShowItemInfo="isShowItemInfo" @sanItemInfoCallBack="sanItemInfoCallBack"></budget-item>
    </section>
</template>
<script>
...
import BudgetItem from "@/components/ItemCom/RepairCuring/BudgetItem";
