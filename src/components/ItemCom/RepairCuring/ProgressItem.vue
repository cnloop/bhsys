            ...
            <div class="sanItemInfo-box-center">
                <table>
                    <tr>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="number"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="machine"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="progress"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="reportDate"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <san-input :sanInputDisabled="true" :sanInputValue.sync="reportPerson"></san-input>
                        </td>
                    </tr>
                    <tr>
                        <td>
...
export default {
  ...
  created() {
    this.number = this.itemInfo.number;
    this.machine = this.itemInfo.machine;
    this.grade = this.itemInfo.grade;
    this.progress = this.itemInfo.progress;
    this.reportDate = this.itemInfo.reportDate;
    this.reportPerson = this.itemInfo.reportPerson;
